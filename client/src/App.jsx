...
export default function App(){ return <BrowserRouter><Routes>
 ...
 <Route element={<ProtectedRoute/>}><Route element={<Layout/>}><Route path="/" element={<Placeholder title="Dashboard"/>}/><Route path="/profile" element={<Placeholder title="Profile"/>}/><Route path="/attendance" element={<Placeholder title="Attendance"/>}/><Route path="/leave" element={<LeavePage/>}/><Route path="/payroll" element={<Placeholder title="Payroll"/>}/></Route></Route>
